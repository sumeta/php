...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h2 align="center">ระบบประกันคุณภาพการศึกษาภายใน (ระบบ IQA) รอบ 12 เดือน</a></h2>
   <h3 align="center">คณะวิทยาศาสตร์และเทคโนโลยี มสด.</h3>
   <!-- <br /> -->
   <div align="right">
...
$(document).ready(function(){
 ...
 $(document).on('click', '.download_file', function(){
  ...
  if(confirm("Are you  want to Download this file?"))
  {
    console.log(name);
